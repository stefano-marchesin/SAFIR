...
flags.add_argument("--delete_ix", default=True, type=bool, help="Delete index, if any.")
...
flags.add_argument("--run_name", default="bm25_ohsu_desc", type=str, help="Run name.")
...
def main():
	...
	rankings_folder = 'corpus/' + FLAGS.corpus_name + '/rankings/lexical_runs'
	...
	utils.evaluate(['map', 'ndcg', 'P_5', 'P_10', 'P_20', 'Rprec', 'num_rel_ret'], rankings_folder, FLAGS.run_name, qrels_folder, FLAGS.qrels_fname)
	if 'CDS' in FLAGS.corpus_name:
		utils.evaluate_inferred(['infAP', 'infNDCG'], rankings_folder, FLAGS.run_name, qrels_folder, FLAGS.inf_qrels_fname) 
